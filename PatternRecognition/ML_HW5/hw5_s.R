...
firstSlope = (w2Mean[2] - w1Mean[2]) / (w2Mean[1] - w1Mean[1])
lines(-2:8, (firstSlope*-2:8)-4)
...
points(w1Proj*-2, JW * (w1Proj*-2)-4, pch = 6, col = 'red')
points(w2Proj*-2, JW * (w2Proj*-2)-4, pch = 5, col = 'blue')
